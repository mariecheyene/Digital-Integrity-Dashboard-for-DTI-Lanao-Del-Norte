...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    setBddOpen(path.includes('/admin/bdd/'));
    setCpdOpen(path.includes('/admin/cpd/'));
  }, [location.pathname]);
  ...
  // CPD sub-modules - Updated with new modules
  const cpdModules = [
    { 
      name: "SP", 
      icon: "bx bxs-chart", 
    ...
    { 
      ...
      icon: "bx bxs-wrench", 
      path: "/admin/cpd/sre", 
      title: "Service and Repair Enterprise",
    },
    { 
      name: "MEDIATION", 
      icon: "bx bxs-hand", 
      path: "/admin/cpd/mediation", 
  ...
  const standaloneModules = [
    { name: "Dashboard", icon: "bx bxs-dashboard", path: "/admin/dashboard", title: "Dashboard Overview" },
    { name: "Users", icon: "bx bxs-user-circle", path: "/admin/user-management", title: "User Management" },
  ];
        ...
        <div className="sidebar-content">
          ...
          <div className="side-menu-container">
            <ul className="side-menu">
              {/* Dashboard and standalone modules */}
      ...
      <div className="content">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/cpd/pm" element={<PM />} />
            <Route path="/cpd/sre" element={<SRE />} />
            <Route path="/cpd/mediation" element={<MEDIATION />} />
          </Routes>
        </main>
      </div>
